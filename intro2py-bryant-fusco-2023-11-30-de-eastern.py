...
try:
    ...
    # 3: Join lst1 and lst2 so only unique string or integer values remain
    # in a new list, lst3.(i.e., ['1', '2', 3, '3', 4, 5, 6])
    # slicing method:
    ...
    # 6: Then, iterate through the values in the odds_evens dictionary.
    # For each number, if it's a string, convert it to an int, otherwise
    # ignore.
    ...
    # 7: Find the maximum number in the numbers list. Then, for each item
    # in the lists of the odds_evens dictionary, add this maximum number to
    # the item and append the result to the numbers list. Try this using
